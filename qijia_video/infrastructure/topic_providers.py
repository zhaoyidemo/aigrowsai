...
TOPIC_EDITOR_PROMPT_VERSION = "family_topic_editor_v1_evidence_only"
...
class OpenRouterTopicEditor:
    ...
    def _prompt(evidence: list[TopicEvidence], valid_through: str) -> str:
        ...
        return (
            ...
            "1. 只能引用输入中的 evidence id，每个候选至少引用 2 条证据，且至少 1 条必须是 video。\n"
            ...
            "7. 五个选题至少覆盖 4 个不同内容支柱，合计至少引用 3 条不同视频样本，"
            "并按证据充分度和齐家定位排序。\n\n"
