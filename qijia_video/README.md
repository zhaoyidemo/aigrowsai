...
`animated-explainer@2.0.0` 借鉴并重新编排了 MIT 许可的 [s1dashu/director](https://github.com/s1dashu/director) 中 Animated Explainer 的具体事件、主体调度与连续性原则；未引入其研究、脚本、语音或 CLI 流程。MiniMax H3 的借鉴范围限定在导演之后的多模态参考角色和供应商提示词表达，不参与脚本选题与论证。
